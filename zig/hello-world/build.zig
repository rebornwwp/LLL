...
pub fn build(b: *std.Build) void {
    ...
    const exe_json_1 = b.addExecutable(.{
        .name = "json_1",
        .root_module = b.createModule(.{
    ...
    b.installArtifact(readLineByLine);

    const file_1_3 = b.addExecutable(.{
        .name = "file_1_3",
        .root_module = b.createModule(.{
    ...
    b.installArtifact(file_1_3);

    const file_1_4 = b.addExecutable(.{
        .name = "file_1_4",
        .root_module = b.createModule(.{
    ...
    b.installArtifact(file_1_4);

    const file_1_5 = b.addExecutable(.{
        .name = "file_1_5",
        .root_module = b.createModule(.{
